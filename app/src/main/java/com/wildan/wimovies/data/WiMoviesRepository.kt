...
class WiMoviesRepository private constructor(
    ...
    companion object{
        @Volatile
        private var instance: WiMoviesRepository? = null

        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): WiMoviesRepository =
            instance ?: synchronized(this) {
                instance ?: WiMoviesRepository(remoteData, localData, appExecutors).apply { instance = this }
            }
    }
